...
namespace Editor {
    ...
    public class Game1 : Game {
        ...
        protected override void Initialize() {
            ...
            rt = new RenderTarget2D(GraphicsDevice, 320, 240);

            //string json = generator.GenerateAnimStrip("walk_side", 23, 25, 10, 2, 33, 30);
            //Console.WriteLine(json);

            //System.IO.File.WriteAllText("..\\..\\..\\..\\ZeldaStyle\\Content\\json\\walk_side.json", json);
            base.Initialize();
        }
        ...
        protected override void Draw(GameTime gameTime) {
            ...
            spriteBatch.Draw(rt, Vector2.Zero, null, Color.White, 0f, Vector2.Zero, 3f, 0, 0f);
